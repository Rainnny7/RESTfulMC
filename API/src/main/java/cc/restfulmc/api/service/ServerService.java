...
import cc.restfulmc.api.common.DNSUtils;
import cc.restfulmc.api.common.EnumUtils;
...
public final class ServerService {
    ...
    @Autowired
    public ServerService(@NonNull MaxMindService maxMindService, @NonNull MinecraftServerCacheRepository minecraftServerCache, @NonNull MojangService mojangService) {
